...
# function. Example of what NOT to try to do. discontinuitySphere.glf is a 
# better approach. Sharp edges should be avoided if possible. See 
# analyticFunctions.glf
################################################################################
